...
from processed_data.modulos.dominio.repositorios import RepositorioDatosProcesados

class RepositorioDatosProcesadosSQLAlchemy(RepositorioDatosProcesados):
